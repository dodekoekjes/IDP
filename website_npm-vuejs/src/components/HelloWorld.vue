  ...
  <div>
    <div class="hero-body">
      <div class="container has-text-centered">
        ...
        <h2 class="subtitle">
          <b>[tell about what the project is]</b>
    ...
    <div>
      <div class="box cta">
        <p class="has-text-centered">
          <span class="tag is-primary">Update</span> [place here the latest update].
        </p>
      </div>
    </div>
    <!--  Card containers -->
          ...
          <div class="card is-shady">
            ...
            <div class="card-content">
              <div class="content">
                ...
                <p><router-link :to="title1.toLowerCase()" class="tag is-info is-large">Learn more</router-link></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card is-shady">
            ...
            <div class="card-content">
              <div class="content">
                ...
                <p><router-link :to="title2.toLowerCase()" class="tag is-info is-large">Learn more</router-link></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card is-shady">
            ...
            <div class="card-content">
              <div class="content">
                ...
                <p><router-link :to="title3.toLowerCase()" class="tag is-info is-large">Learn more</router-link></p>
              </div>
            </div>
          </div>
        </div>
