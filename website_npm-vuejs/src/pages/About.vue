...
<style scoped>
  ...
  *,:after,:before {
  ...
  .has-text-primary {
    color:#507ce8!important
  }
  a.has-text-primary:focus,a.has-text-primary:hover {
    color:#235ae2!important
  }
  .has-text-link {
  ...
  .hero.is-light.is-bold {
    background-image:linear-gradient(141deg,#98c2f3,#c9d6f5 71%,#dee1fa)
  }
  @media screen and (max-width:768px) {
  ...
  .hero.is-primary.is-bold {
    background-image:linear-gradient(141deg,#1679ef,#507ce8 71%,#6274ef)
  }
  @media screen and (max-width:768px) {
  ...
  .navbar .nav-menu-item.is-active,.navbar .nav-menu-item:hover {
    color:#44485b
  }
  .heading {
    font-size:36px;
  ...
  * {
  ...
  .shortcut-stats-group {
    position:relative;
    margin:auto;
    width:360px;
    height:420px
  }
  .shortcut-stats-group .shortcut-stats {
    position:absolute;
    width:360px;
    height:420px;
    background:#fff;
  ...
  .shortcut-stats-group .shortcut-stats-icon {
    width:120px;
    margin-bottom:2rem
  }
  .shortcut-stats-group .shortcut-stats-chart {
    margin-top:2rem
  }
  .shortcut-stats-group ul {
    list-style:disc
  }
  .footer-section {
    display:flex;
  ...
  @media screen and (max-width:768px) {
    ...
    .footer-section,.shortcut-stats-group {
      display:flex;
      justify-content:center;
      align-items:center
    }
